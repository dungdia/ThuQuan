thanhvienvatdungvatdungnhanvien-- MySQL dump 10.13  Distrib 8.0.41, for Win64 (x86_64)
--
...
CREATE TABLE `chitietphieutra` (
  ...
  `id_vatdung` int NOT NULL,
  `tinhtrang` enum('Nguyên vẹn','Hư hỏng') NOT NULL,
...
INSERT INTO `phieudat` VALUES (16,1,'2025-04-16 00:00:00','Đã xuất phiếu'),(17,1,'2025-04-16 00:00:00','Đã xuất phiếu'),(18,1,'2025-04-16 10:12:30','Đã xuất phiếu'),(19,1,'2025-04-17 09:32:16','Đã xuất phiếu'),(22,14,'2025-04-17 09:45:05','Đã xuất phiếu'),(23,1,'2025-04-29 05:00:00','Đã xuất phiếu');
...
CREATE TABLE `phieumuon` (
  ...
  `tinhtrang` enum('Đã xuất phiếu','Đã huỷ','Ẩn') NOT NULL,
  PRIMARY KEY (`id`),
...
INSERT INTO `thanhvien` VALUES (1,'minh duc hih ihi','0999999999',1,'Hoạt động'),(12,'Dũng 124124','0899304226',12,'Đã bị khoá'),(13,'','',13,'Hoạt động'),(14,'','',15,'Hoạt động');
...
-- Dump completed on 2025-04-29 20:20:29
