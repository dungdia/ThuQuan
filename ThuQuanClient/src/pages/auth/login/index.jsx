    ...
    <>
      ...
      <main className="auth">
        ...
        <div className="auth__intro">
          ...
          <img src={introRegister} alt="intro" className="auth__intro-img" />
        ...
        <div id="auth-content-login" className="auth__content-login hide">
          <div className="auth__content-login-inner">
            ...
            <p className="auth__desc">
              ...
              có thể truy cập vào tất cả thông tin đã lưu trước đó.
            </p>
            <Form
              // form={form}
              onFinish={onFinish}
            ...
            >
              <Form.Item
                ...
                label={
                  <span className="auth__form-login-lable-input">Email</span>
                }
                name="email"
                rules={[
                  {
              ...
              >
                <Input
                  prefix={<UserRound className="auth__form-login-icon icon" />}
                  placeholder="Email"
              ...
              <Form.Item
                className="auth__form-login-item"
                label={<span className="auth__form-lable-input">Mật khẩu</span>}
                name="password"
                rules={[
                  {
                    required: true,
